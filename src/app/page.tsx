        ...
        <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight px-2 sm:px-0">
              ...
              <span className="text-blue-600"> Web3 safe space</span> where your
              feelings matter
            </h1>

            <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
              Share your thoughts without fear, receive AI-powered emotional
              support, and earn rewards for helping others. Your care has real
              value.
            </p>

            <button
              onClick={handleMainButtonClick}
              className={`px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg transition-colors ${
                address
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-blue-50 p-6 sm:p-8 rounded-2xl">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Only your wallet address is visible. Share your deepest
                  thoughts without fear of judgment or exposure.
                </p>
              </div>
              ...
              <div className="bg-purple-50 p-6 sm:p-8 rounded-2xl">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Replies adapt to your tone: serious, casual, or even playful.
                  Get support that actually understands you.
                </p>
              </div>
              ...
              <div className="bg-green-50 p-6 sm:p-8 rounded-2xl sm:col-span-2 md:col-span-1">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-3">
                  Global Tokenized Community
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Join channels by topic or country, connect with the world, and
                  earn SOL for supporting others in meaningful ways.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 sm:py-20 px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-10 sm:mb-16 max-w-2xl mx-auto px-2 sm:px-0">
              Channels by topic and country for meaningful connections. Your
              emotional wellbeing, powered by Web3.
            </p>
              ...
              <div className="flex flex-col sm:flex-row items-start space-y-4 sm:space-y-0 sm:space-x-4 text-left max-w-2xl mx-auto">
                ...
                <div className="flex-1 w-full">
                  ...
                  <div className="text-sm sm:text-base text-gray-900 mb-4">
                    &quot;Just got liquidated on my ETH long position because of
                    that surprise Fed announcement. Lost 3 months of DCA savings
                    in 10 minutes... Why did I use 100x leverage? Feeling so
                    stupid right now 😭&quot;
                  </div>
                  <div className="bg-blue-50 border-l-4 border-blue-400 p-3 sm:p-4 rounded-r-lg">
                    ...
                    <div className="text-blue-800 text-xs sm:text-sm">
                      &quot;Ouch, that stings anon. Fed announcements are brutal
                      for leveraged positions. Take a breather, then maybe stick
                      to spot trading for a while? If you&quot;re gonna use
                      leverage again, 2-3x max with proper stop losses. The
                      market will always be here tomorrow 🫂&quot;
                    </div>
                  </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white rounded-2xl p-6 sm:p-12 shadow-sm border border-gray-200">
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4 px-2 sm:px-0">
                Ready to join the world&apos;s first tokenized emotional support
                network?
              </h2>
              <p className="text-gray-600 mb-6 sm:mb-8 text-base sm:text-lg px-2 sm:px-0">
                Connect your Base wallet and start sharing anonymously. Your
                feelings matter, and your care has real value.
              </p>
              <button
                onClick={handleMainButtonClick}
                className={`px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg transition-colors ${
