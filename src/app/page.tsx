          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-blue-50 rounded-xl p-6 sm:p-8 border border-blue-100">
                ...
                <div className="text-3xl sm:text-4xl font-bold text-gray-900 mb-1">
                  {stats.isLoading ? (
                    <div className="h-10 w-20 bg-blue-200 rounded animate-pulse"></div>
                  ) : (
                    stats.totalUsers
                  )}
                </div>
                <p className="text-gray-700 text-sm sm:text-base">anonymous users sharing their feelings</p>
              </div>
              ...
              <div className="bg-purple-50 rounded-xl p-6 sm:p-8 border border-purple-100">
                ...
                <div className="text-3xl sm:text-4xl font-bold text-gray-900 mb-1">
                  {stats.isLoading ? (
                    <div className="h-10 w-20 bg-purple-200 rounded animate-pulse"></div>
                  ) : (
                    stats.totalPosts
                  )}
                </div>
                <p className="text-gray-700 text-sm sm:text-base">stories shared & supported by AI</p>
              </div>
              ...
              <div className="bg-green-50 rounded-xl p-6 sm:p-8 border border-green-100">
                ...
                <div className="text-3xl sm:text-4xl font-bold text-gray-900 mb-1">
                  {stats.isLoading ? (
                    ...
                    <span className="text-2xl sm:text-3xl">{stats.totalValueETH} ETH</span>
                  )}
                </div>
                <p className="text-gray-700 text-sm sm:text-base">
                  {stats.isLoading ? 'in tips shared' : `~$${stats.totalValueUSD} in tips shared`}
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-500">
                Stats update live from Base Sepolia
              </p>
            </div>
          </div>
        </section>
