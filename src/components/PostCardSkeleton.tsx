export default function PostCardSkeleton() {
    return (
        <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 shadow-sm animate-pulse">
            <div className="flex items-start space-x-3 sm:space-x-4">
                {/* Avatar skeleton */}
                <div className="bg-gray-200 w-8 h-8 sm:w-10 sm:h-10 rounded-full flex-shrink-0"></div>
